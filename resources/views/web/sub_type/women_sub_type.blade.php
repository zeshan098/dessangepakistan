...
<div class="portfolio-area ptb-30">
			<div class="container-fluid">
				...
				<div class="portfolio-style-2">
					<div class="row grid">	
                    @foreach($women_sub_type as $women_sub_type) 				
						<div class="col-lg-3 col-md-6 col-sm-6 col-12 grid-item cat2 cat3">
							<div class="portfolio hover-style">
								<div class="portfolio-img">
									<img src="../img/sub_type/{{$women_sub_type->image}}" alt="" />
									<div class="portfolio-view">
										<a class="img-poppu" href="/women-services/{{$women_sub_type->slug}}">
											<span class="plus"></span>
										</a>								
									</div>
								</div>
								<div class="portfolio-title">
									<h3><a href="/women-services/{{$women_sub_type->slug}}">{{$women_sub_type->name}}</a></h3> 
								</div>								
							</div>						
						</div>
		...
		<div class="container">
                <div class="row">
                 <div class="col-lg-12">
                 <p>{!!$women_sub_type_meta->major_content!!}</p>
                 </div>
                </div>
            </div>	
