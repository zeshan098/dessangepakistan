...
<head>
    <title>{{$service_detail->meta_title}}</title> 
    <meta name="description" content="{{$service_detail->meta_description}}">
    <meta name="keywords" content="{{$service_detail->meta_keywords}}"> 
...
<div class="portfolio-area ptb-30">
					...
					<div class="row grid">					
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 grid-item cat2 cat3">
							<div class="project-desc">
								...
								@if($service_detail->duration == "") 
								
								@else
								<p>Duration: {{$service_detail->duration}}</p>
								@endif
								
								@if($service_detail->video_link == "") 
                                    
                                 @else 
                                    <button type="button" class="btn btn-primary video-btn" data-toggle="modal" data-src="{{$service_detail->video_link}}" data-target="#myModal">Play Video</button>
                                @endif
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 grid-item cat2 cat3">
                            ...
                            <img id="zoom_10" style="max-width:100%;" src="../img/service/{{$service_detail->picture}}"data-zoom-image="../img/service/{{$service_detail->picture}}">
                             
		                 </div>				
						</div>
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 grid-item cat2 cat3">
							<div class="project-desc">
								<h3>Starting From RS.{{$service_detail->cost}}</h3>
								<br>
								<div class="price-btn">
								...
								<button data-id="{{$service_detail->id}}" data-name="{{$service_detail->name}}" data-price="{{$service_detail->cost}}" data-purchase="service" data-toggle="modal" data-target="#cart" class="submit add-to-cart" type="submit" style="padding: 10px 107px; font-size: 17px; font-weight: 100;
	    	...
	    	<div class="container">
                <div class="row">
                 <div class="col-lg-12">
                 <p>{!!$service_detail->service_content!!}</p>
                 </div>
                </div>
            </div>	
		<!-- portfolio area end -->
