						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-12 grid-item cat1">
							<div class="portfolio hover-style m-0">
								<div class="portfolio-img">
									<img src="{{asset('img/product_major_type/'. $main_content->image)}}" alt="" />
									<div class="portfolio-view">
										<a class="img-poppu" href="/product/product-major/{{$main_content->id}}">
											<span class="plus"></span>
										</a>								
									</div>
								</div>
								<div class="portfolio-title">
									<h3><a href="/product/product-major/{{$main_content->id}}">{{$main_content->name}}</a></h3>
