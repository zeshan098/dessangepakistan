...
<section class="content">
    <div class="row">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('social/create_service') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="service_name" id="heading"   required="">
                    </div>
                    <div class="form-group">
                        <label for="first_name">Description</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control datepicker" name="start_date" id="description"  autocomplete="off" required="">
                    </div>
                    <div class="form-group">
                        <label for="first_name">End Date</label>
                        <input type="text" class="form-control datepicker" name="end_date" id="heading"   autocomplete="off">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="duration" id="heading"   required="">
                    </div>
                    <div class="form-group">
                        <label for="first_name">Major Type</label>
                            <select name="major_type_id" id="major_type_id"   class="form-control"> 
                                ...
                                <option value="{{$mj_type->id}}">{{$mj_type->name}} -- {{$mj_type->category_type}}</option>
                                @endforeach
                            </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="video_link" id="heading" >
                    </div> 
                    <div class="form-group">
