    ...
    <div class="row">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Add MajorType</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('social/create_major_type') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="box-header with-border">
                          ...
                          <textarea id="editor1" name="major_content" rows="10" cols="80"></textarea>
                          </div>
                      </div>
                    <div class="form-group">
