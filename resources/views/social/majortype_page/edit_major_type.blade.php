    ...
    <div class="row">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Edit MajorType</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('social/update_major_type', $edit_major_type->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="first_name">Category Type</label>
                         <select name="category_type" id="category_id"  class="form-control">
                            <option {{ ($edit_major_type->category_type) == 'men' ? 'selected' : '' }} value="men">Male</option> 
                             <option {{ ($edit_major_type->category_type) == 'women' ? 'selected' : '' }} value="women">Female</option> 
                   ...
                   <div class="form-group">
                        ...
                        <img src="{{asset('img/major_type/'. $edit_major_type->image)}}"   id="preview">
                    </div> 
