...
<section class="content">
    <div class="row">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('social/create_sub_type') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="first_name">Category</label>
                         ...
                         @foreach($major_type as $major_type)
                            <option value="{{$major_type->id}}">{{$major_type->name}} -- {{$major_type->category_type}}</option>
                        @endforeach 
                        </select>
                    </div>
