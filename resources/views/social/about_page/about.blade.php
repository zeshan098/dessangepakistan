...
<section class="content">
    <div class="row">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('social/upload_about_detail') }}" method="post" enctype="multipart/form-data">
                <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                <div class="box-body">
                    <div class="form-group">
                        <label for="first_name">About Heading</label>
                        <input type="text" class="form-control" name="about_heading" id="heading"   required="">
                    </div>
                    <div class="form-group">
                        <label for="first_name">About Main Heading</label>
                        <input type="text" class="form-control" name="about_main_heading" id="button_heading"   required="">
                    </div> 
                    <div class="form-group">
