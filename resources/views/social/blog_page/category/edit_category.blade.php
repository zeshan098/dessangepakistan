...
<section class="content">
    <div class="row">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('social/update_category', $edit_category->id) }}" method="post"  >
                <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                <div class="box-body">
                     
                    <div class="form-group">
                        <label for="first_name">Category Name</label>
                        <input type="text" class="form-control" name="category_name" id="heading" value="{{$edit_category->category_name}}"  required="">
                    </div>
