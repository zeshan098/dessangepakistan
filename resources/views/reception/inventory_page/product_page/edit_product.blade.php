...
<section class="content">
    <div class="row">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ url('reception/update_product', $edit_product->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="box-header with-border">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="meta_title" value="{{$edit_product->meta_title}}">
                        </div> 
                        <div class="form-group">
                            <label for="first_name">Meta Keywords</label>
                            <input type="text" class="form-control" name="meta_keywords" value="{{$edit_product->meta_keywords}}">
                        </div>
                        <div class="form-group">
                            <label for="first_name">Slugs</label>
                            <input type="text" class="form-control" name="slug" value="{{$edit_product->slug}}">
                        </div>
                        <div class="form-group">
                           <label for="first_name">Description</label>
                           <textarea id="editor2" name="meta_description" rows="10" cols="80">{!!$edit_product->meta_description!!}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="first_name">Description</label>
                        <textarea id="editor1" name="description" rows="10" cols="80">{!!$edit_product->description!!}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="first_name">Reference Number</label>
                        <input type="text" class="form-control" name="reference_number" id="heading"  value="{{$edit_product->reference_number}}" required="">
                    </div> 
                    <div class="form-group">
                        <label for="first_name">Cost</label>
                        <input type="text" class="form-control" name="cost" id="heading"  value="{{$edit_product->cost}}" required="">
                    </div> 
                    <div class="form-group">
                        <label for="first_name">Major Type</label>
                            <select name="major_type_id" id="major_type_id"   class="form-control">  
                                ...
                                <option value="{{$mj_type->id}}" {{ $mj_type->id == $edit_product->major_type_id ? 'selected' : '' }}>{{$mj_type->name}}</option>
                                @endforeach
                            </select>
                    </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                        ...
                        <img src="{{asset('img/product/'. $edit_product->picture)}}"   id="preview">
                    </div> 
                     
                    <div class="form-group">
                        <label for="first_name">Status</label>
                        <select name="status" id="category_id" class="form-control" require>  
                           <option {{ ($edit_product->status) == 'open' ? 'selected' : '' }} value="open">Open</option> 
                           <option {{ ($edit_product->status) == 'close' ? 'selected' : '' }} value="close">Close</option> 
